...
**Tech Stack:** Kotlin/JVM, Angus Mail 2.0.5/Jakarta Mail API 2.1.5, Ktor multipart/SSE, allowlisted Docker Compose logs, Dovecot `doveadm save`, Postfix SMTP, Stalwart v0.16.15 JMAP upload/import/EmailSubmission, SQLite JDBC 3.53.2.1 event cache.
