...
> **Superseded dependency baseline:** This completed Gate 0B plan preserves the Stalwart v0.16.14 commands and evidence it actually proved. Active future work now targets Stalwart v0.16.15 under the 2026-08-01 latest-coherent dependency plan; do not rewrite the historical steps below as v0.16.15 evidence.
