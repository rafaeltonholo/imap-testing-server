...
**Tech Stack:** Kotlin/JVM, Jakarta Mail API 2.1.5, Angus Mail 2.0.5, Ktor client, kotlinx.serialization, IMAP UIDPLUS/MOVE where advertised, Stalwart v0.16.17 JMAP Mail.
