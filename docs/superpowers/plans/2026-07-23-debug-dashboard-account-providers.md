...
**Tech Stack:** Kotlin/JVM, Ktor client/server, kotlinx.serialization, JDK NIO atomic file operations, allowlisted `docker compose`/`doveadm`, Stalwart v0.16.17 JMAP management.
